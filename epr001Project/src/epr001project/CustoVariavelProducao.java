...
public class CustoVariavelProducao extends javax.swing.JPanel {
    ...
    public CustoVariavelProducao(JFrame j) {
        ...
        JTextArea label = new JTextArea("Custo variável de produção \n" +
"	Os custos de produção são aqueles que ocorrem na fabricação do produto. \n" +
"	No caso dos custo variáveis de produção são auqeles que variam de acordo com a quantidade produzida.\n" +
"	Outros: adiciona-se nesse campo todos os custo variáveis não listados acima. 	\n" +
